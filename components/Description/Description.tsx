export const Description = () => {
  return (
    <p className="text-lg font-medium rounded-xl">
      I&apos;m a{' '}
      ...
      I bring a comprehensive perspective to mobile development, building
      scalable, user-centric solutions and exploring how AI can enhance product
      performance and developer workflows.
    </p>
  );
};
